...
impl MLModelRef {
    ...
    pub fn model_description(&self) -> &MLModelDescriptionRef {
        unsafe { msg_send![self, modelDescription] }
    }
    ...
    pub fn configuration(&self) -> &MLModelDescriptionRef {
        unsafe { msg_send![self, configuration] }
    }
